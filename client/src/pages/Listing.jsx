...
export default function Listing() {
  ...
  return (
    <main>
      {loading && <p className="text-center my-7 text-2xl"><PropagateLoader color="rgb(51 65 85)"/></p>}
      {error && (
      ...
      {listing && !loading && !error && (
        <div>
          ...
          <p className="text-slate-800">
            <span className="font-semibold text-black"> Description - {' '}</span>{listing.description}</p>
            ...
            <button onClick={()=>setContact(true)} className="bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95" >Contact Landlord</button>
            }
